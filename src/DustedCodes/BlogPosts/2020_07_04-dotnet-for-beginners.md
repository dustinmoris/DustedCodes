...
Another great example is the growing variety of C# data types. When is it appropriate to create a [data class](), an [immutable data class](), a [mutable struct](), an [immutable struct](), a [tuple class](), the new concept of [named tuples]() or the upcoming [record type](https://www.stevefenton.co.uk/2020/05/csharp-9-record-types/)?
